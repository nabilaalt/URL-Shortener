...
const LinkPage = () => {
  ...
  const weeklyClicks =
    stats?.weekly_clicks?.[DateTime.fromISO(currentDateISO).toFormat("kkkk-'W'W").toString()]
      ?.clicks || 0;
      ...
      <div className="flex flex-col gap-8 sm:flex-row justify-between px-4 sm:px-8 py-6">
          <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
            ...
            navigator.clipboard.writeText(`${URL_APP}/${link}`)
              ...
              className="border-rose-500  text-white hover:border-rose-500  hover:bg-rose-500" onClick={downloadImage}>
                <Download />
              </Button>
              <Button
                variant="outline"
